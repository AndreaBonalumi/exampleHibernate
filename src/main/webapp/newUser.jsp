...
<form action="UserServlet?action=new" method="post">
  ...
  <label for="username">Last name: </label> <input id="username" type="text" name="username" placeholder="username" /><br><br>
  ...
  <label for="bd">Nome: </label> <input id="bd" type="date" name="bd" placeholder="Birthday" /><br><br>
  <label for="nPatente">Nome: </label> <input id="nPatente" type="text" name="nPatente" placeholder="Numero Patente" /><br><br>
